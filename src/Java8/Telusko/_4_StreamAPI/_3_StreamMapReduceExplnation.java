 ...
 * 
 */
package Java8.Telusko._4_StreamAPI;
...
public class _3_StreamMapReduceExplnation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Stream object s : "+s1);
		
		//Now we need to multiply every number by 2
		//For that we need use map(), but map() take object of Function
