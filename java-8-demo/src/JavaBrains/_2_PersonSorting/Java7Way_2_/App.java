 ...
 * 
 */
package JavaBrains._2_PersonSorting.Java7Way_2_;
...
*/
	//Instead of "printLastNameBeginningWithC", we make "printLastNameBeginningConditionally"
	private static void printLastNameBeginningConditionally(List<Person> persons, Condition condition) {
		for( Person person : persons) {
